...
sap.ui.define([
	...
	"mpn/PM/js/formatter"
], function(Controller, MessageToast, Device, JSONModel, Purchase, formatter) {
	"use strict";
		...
		onPressShopItem: function(oEvent){
			...
			purchase.getPurchasesByShopId(iSelGesId, function(data, error){
				if(error === undefined){
					...
					MessageToast.show("Die Einkäufe konnten nicht geladen werden. Bitte wende dich an den Entwickler.");
				}
			});
